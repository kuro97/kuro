...
# 30 дней = 720 часов: ловим изменения статусов/городов даже у лидов
# которые были созданы давно. Когда в AMO настроится webhook —
# можно уменьшить (тогда основной канал = webhook real-time, polling — страховка).
